    ...
    return `
      ...
      <head>
        ...
        <style>
          ...
          .header { background: #007bff; color: white; text-align: center; padding: 30px; border-radius: 8px 8px 0 0; }
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <p>Hello!</p>
            <p>Thank you for registering with our Freelancer Platform. To complete your registration, please verify your email address by entering the following verification code:</p>
    ...
    return `
      ...
      <head>
        ...
        <style>
          body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; }
          .container { max-width: 600px; margin: 0 auto; padding: 20px; }
          .header { background: #dc3545; color: white; text-align: center; padding: 30px; border-radius: 8px 8px 0 0; }
          .content { background: #f8f9fa; padding: 30px; border-radius: 0 0 8px 8px; }
          .otp-code { 
            font-size: 32px; 
            font-weight: bold; 
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <p>Hello!</p>
            <p>We received a request to reset your password for your Freelancer Platform account. Use the following code to reset your password:</p>
    ...
    return `
      ...
      <head>
        ...
        <style>
          body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; }
          .container { max-width: 600px; margin: 0 auto; padding: 20px; }
          .header { background: #28a745; color: white; text-align: center; padding: 30px; border-radius: 8px 8px 0 0; }
          .content { background: #f8f9fa; padding: 30px; border-radius: 0 0 8px 8px; }
          .otp-code { 
            font-size: 32px; 
            font-weight: bold; 
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <p>Hello!</p>
            <p>We noticed a login attempt to your Freelancer Platform account. Use the following verification code to complete your login:</p>
  ...
  private getWelcomeTemplate(firstName: string): string {
    return `
      ...
      <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Welcome to Freelancer Platform</title>
        <style>
          body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0; }
          .container { max-width: 600px; margin: 0 auto; padding: 20px; }
          .header { background: #28a745; color: white; text-align: center; padding: 30px; border-radius: 8px 8px 0 0; }
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <p>Hello ${firstName}!</p>
            <p>Welcome to our amazing freelancer platform. We're excited to have you on board!</p>
            <p>You can now start exploring opportunities and connecting with clients or freelancers.</p>
