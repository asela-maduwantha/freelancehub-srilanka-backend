...
export class PricingDto {
  @ApiProperty({
    description: 'The amount for the pricing',
    type: 'number',
    example: 500,
    minimum: 0,
  })
  ...
  @ApiPropertyOptional({
    description: 'The breakdown of the pricing',
...
export class MilestoneDto {
  ...
  @ApiProperty({
    ...
    example: 'Complete front end development',
  })
  @IsNotEmpty()
  @IsString()
  description: string;
  ...
  @ApiProperty({
    description: 'The delivery date for the milestone',
    example: '2025-09-15',
  })
  @IsNotEmpty()
  @IsDateString()
...
export class TimelineDto {
  @ApiProperty({
    description: 'The delivery time in days',
    type: 'number',
    example: 50,
    minimum: 1,
  })
...
export class AttachmentDto {
  @ApiProperty({
    ...
    example:
      'https://freelancehub.blob.core.windows.net/freelancehubfiles/proposals/file.pdf',
  })
  @IsNotEmpty()
  @IsString()
  url: string;
...
export class SubmitProposalDto {
  @ApiPropertyOptional({
    description: 'The ID of the project (optional if passed in URL)',
    example: 'proj123',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'The list of portfolio links',
    type: [String],
  ...
  @ApiPropertyOptional({
    description: 'Legacy proposed budget field',
    type: 'number',
    example: 500,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Legacy proposed duration field',
    type: 'number',
    example: 30,
  })
  @IsOptional()
