    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        doc
          .fontSize(20)
          .font('Helvetica-Bold')
          .text('FREELANCE CONTRACT', { align: 'center' });
        doc.moveDown(2);
        ...
        doc.text(
          `Start Date: ${contract.startDate?.toISOString().split('T')[0] || 'N/A'}`,
        );
        doc.text(
          `End Date: ${contract.endDate?.toISOString().split('T')[0] || 'N/A'}`,
        );
        ...
        doc
          .fontSize(14)
          .font('Helvetica-Bold')
          .text('Project Milestones', { underline: true });
        doc.moveDown(0.5);
        doc.fontSize(12).font('Helvetica');
        ...
        doc.text(
          '1. The freelancer agrees to complete all milestones according to the specifications provided.',
        );
        doc.text(
          '2. The client agrees to make payments according to the payment schedule outlined above.',
        );
        doc.text(
          '3. Any changes to the project scope must be agreed upon by both parties in writing.',
        );
        doc.text(
          '4. The freelancer retains all rights to the source code and deliverables until full payment is received.',
        );
        doc.text(
          '5. Both parties agree to communicate regularly and provide feedback in a timely manner.',
        );
        doc.moveDown(2);
        ...
        doc.text(
          'This contract is electronically generated and legally binding.',
          { align: 'center' },
        );
